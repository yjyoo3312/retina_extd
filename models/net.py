...
class FPN(nn.Module):
    def __init__(self,in_channels_list,out_channels,fpn_num=5):
        ...
        if self.fpn_num == 5:
            ...
            self.output5 = conv_bn1X1(in_channels_list[3], out_channels, stride=1, leaky=leaky)
            self.merge4 = conv_bn(out_channels, out_channels, leaky=leaky)
